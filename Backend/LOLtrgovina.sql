...
GO
ALTER DATABASE db_ab2ce7_loltrgovina SET SINGLE_USER WITH
ROLLBACK IMMEDIATE;
GO
ALTER DATABASE db_ab2ce7_loltrgovina COLLATE Croatian_CI_AS;
GO
ALTER DATABASE db_ab2ce7_loltrgovina SET MULTI_USER;
GO
SELECT name, collation_name FROM sys.databases;
GO
